...
var routes = [
  ...
  // },
  {
    ...
    loadComponent: () => import("./chunk-D3MA6SJK.js").then((m) => m.AuthenticatedTemplateComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-BJXDYSGO.js").then((m) => m.DashboardComponent)
      }
    ]
  },
  {
    path: "login",
    loadComponent: () => import("./chunk-DTIJRTLR.js").then((m) => m.LoginComponent)
  },
  {
    path: "register",
    loadComponent: () => import("./chunk-ICOXX6IQ.js").then((m) => m.RegisterComponent)
  },
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-6XSWKXPL.js").then((m) => m.UnauthorizedComponent)
  }
  // {
  //   path: '**',
  //   redirectTo: 'dashboard',
...
var refreshResultSubject = new Subject();
...
function handleUnauthorizedError(request, next, authService, router) {
  if (!isRefreshing) {
    isRefreshing = true;
    ...
    return refreshResultSubject.pipe(first(), switchMap((result) => {
      if (result.success) {
...
// src/app/shared/constants/icons.constants.ts
var customIcons;
(function(customIcons2) {
  customIcons2["plFlag"] = "plFlag";
  customIcons2["enFlag"] = "enFlag";
...
var IconsService = class _IconsService {
  ...
  static \u0275fac = function IconsService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _IconsService)(\u0275\u0275inject(MatIconRegistry), \u0275\u0275inject(DomSanitizer));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _IconsService, factory: _IconsService.\u0275fac, providedIn: "root" });
};
(() => {
...
var App = class _App {
  translate;
  iconsService;
  title = signal("angular-finance", ...ngDevMode ? [{ debugName: "title" }] : []);
  constructor(translate, iconsService) {
  ...
  static \u0275fac = function App_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _App)(\u0275\u0275directiveInject(TranslateService), \u0275\u0275directiveInject(IconsService));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(App, [{
    type: Component,
    args: [{ selector: "app-root", imports: [RouterOutlet, SidebarComponent], template: "\n<router-outlet></router-outlet>\n\n", styles: ["/* src/app/app.scss */\n:host {\n  background:\n    linear-gradient(\n      135deg,\n      #667eea 0%,\n      #764ba2 100%);\n}\n/*# sourceMappingURL=app.css.map */\n"] }]
  }], () => [{ type: TranslateService }, { type: IconsService }], null);
})();
(() => {
