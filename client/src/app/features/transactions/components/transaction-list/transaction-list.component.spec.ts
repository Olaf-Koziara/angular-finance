...
describe('TransactionListComponent', () => {
  ...
  describe('Template Rendering', () => {
    ...
    it('should render type chip with correct color for income', () => {
      ...
      expect(incomeChip?.componentInstance.color).toBe('primary');
    });
    ...
    it('should render type chip with correct color for expense', () => {
      ...
      expect(expenseChips[0].componentInstance.color).toBe('warn');
    });
  ...
  describe('Accessibility', () => {
    ...
    it('should have aria-label on checkboxes when selectionMode is enabled', () => {
      fixture.componentRef.setInput('selectionMode', true);
      fixture.detectChanges();

      const selectAllCheckboxInput = fixture.debugElement.query(By.css('th mat-checkbox input'));
      const rowCheckboxInput = fixture.debugElement.query(By.css('td mat-checkbox input'));

      expect(selectAllCheckboxInput.nativeElement.getAttribute('aria-label')).toBe('TRANSACTIONS.SELECT_ALL');
      expect(rowCheckboxInput.nativeElement.getAttribute('aria-label')).toBe('TRANSACTIONS.SELECT_ITEM');
    });
  });
  ...
  describe('Component Properties', () => {
    // Skipped: Constructor name check is fragile (e.g. mangling or decoration)
    ...
    // Skipped: Overwriting a property on the instance is not guaranteed to throw in JS unless frozen
