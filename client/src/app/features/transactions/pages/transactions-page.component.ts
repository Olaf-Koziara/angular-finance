...
import { CreateTransaction, TransactionFilters } from '../models/transaction.model';
import { TransactionService } from '../services/transaction.service';

@Component({
  selector: 'app-transactions-page',
  standalone: true,
  imports: [CommonModule, MatCardModule, TransactionFormComponent, TransactionListComponent, TranslateModule,TransactionPaginationComponent,TransactionFiltersComponent],
