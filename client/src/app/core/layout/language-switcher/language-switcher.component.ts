...
import { LANGUAGE_TRANSLATION_KEYS, LanguageCode, SUPPORTED_LANGUAGES } from "../../../shared/constants/language.constants";

@Component({
    selector: 'app-language-switcher',
    templateUrl: './language-switcher.component.html',
    styleUrls: ['./language-switcher.component.scss'],
    imports: [FormsModule, MatFormFieldModule, MatButtonModule, TranslateModule, MatMenuModule, MatIconModule],
    standalone: true,
})
